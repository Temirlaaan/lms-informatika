...
export const createLesson = (data: { topic: number; content: string; video_url?: string }) => api.post('/courses/teacher/lessons/', data);
export const updateLesson = (id: number, data: { content: string; video_url?: string }) => api.put(`/courses/teacher/lessons/${id}/`, data);
