...
export const updateSection = (id: number, data: Partial<Section>) => api.patch(`/courses/teacher/sections/${id}/`, data);
...
export const updateTopic = (id: number, data: Partial<Topic>) => api.patch(`/courses/teacher/topics/${id}/`, data);
...
export const updateQuiz = (id: number, data: Partial<Quiz>) => api.patch(`/quizzes/teacher/quizzes/${id}/`, data);
...
export const updateQuestion = (id: number, data: Partial<Question>) => api.patch(`/quizzes/teacher/questions/${id}/`, data);
...
export const updateChoice = (id: number, data: Partial<Choice>) => api.patch(`/quizzes/teacher/choices/${id}/`, data);
